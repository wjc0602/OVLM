...
cfg.MODEL.LANGUAGE.ENABLE = False
cfg.MODEL.LANGUAGE.TYPE = "robert"
...
# MODEL.RESULT_EVAL
cfg.MODEL.RESULT_EVAL = edict()
cfg.MODEL.RESULT_EVAL.TYPE = "multimodal"
cfg.MODEL.RESULT_EVAL.ENABLE = False
...
cfg.TRAIN.DROP_PATH_RATE = 0.1  # drop path rate for ViT backbone_img
...
cfg.TEST.GPU_MEMORY_THRESHOLD = 3000
...
cfg.TEST.ONLINE_SIZES.TNL2K = 3
cfg.TEST.ONLINE_SIZES.OTB = 3
cfg.TEST.ONLINE_SIZES.LASOT_EXTENSION_SUBSET = 3

cfg.TEST.CONFIDENCE_THRESHOLD = edict()
cfg.TEST.CONFIDENCE_THRESHOLD.LASOT = [0.5]
cfg.TEST.CONFIDENCE_THRESHOLD.TNL2K = [0.5]
cfg.TEST.CONFIDENCE_THRESHOLD.OTB = [0.5]
