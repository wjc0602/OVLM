...
class BaseBackbone(nn.Module):
    ...
    def forward_features(self, z, x, text_src=None):
        ...
        # x[32,256,768],z[32,64,768],txt[32,40,768]
        z = torch.cat(z, dim=1)
    ...
    def forward(self, z, x, text_src, **kwargs):
        """
        Joint feature extraction and relation modeling for the basic ViT backbone_img.
        Args:
        ...
        Returns:
            ...
            attn : None
        """
        x, aux_dict = self.forward_features(z, x, text_src)
