...
class TrackingSampler(torch.utils.data.Dataset):
    ...
    def __init__(self, datasets, p_datasets, samples_per_epoch, max_gap,
                 ...
                 train_cls=False, pos_prob=0.5, tokenizer='roberta-base'):
        """
        args:
    ...
    def getitem(self):
        ...
        while not valid:
            ...
            if is_video_dataset:
                ...
                if self.frame_sample_mode == 'causal':
                    ...
                    while search_frame_ids is None:
                        base_frame_id = self._sample_visible_ids(visible, num_ids=1, min_id=self.num_template_frames - 1, max_id=len(visible) - self.num_search_frames)
            ...
            try:
                template_frames, template_anno, meta_obj_train, nlp = dataset.get_frames(seq_id, template_frame_ids, seq_info_dict)
                search_frames, search_anno, meta_obj_test, _ = dataset.get_frames(seq_id, search_frame_ids, seq_info_dict)
                ...
                text_ids = nlp_encoded["input_ids"]
                text_masks = nlp_encoded["attention_mask"]
    ...
    def get_one_search(self):
        ...
        search_frames, search_anno, meta_obj_test, nlp = dataset.get_frames(seq_id, search_frame_ids, seq_info_dict)
