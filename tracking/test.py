...
def main():
    ...
    parser.add_argument('--tracker_param', type=str, default='momn_3_all_300', help='Name of config file.')
    parser.add_argument('--runid', type=int, default=0, help='The run id.')
    parser.add_argument('--dataset_name', type=str, default='lasot', help='Name of dataset (otb,  lasot, tnl2k).')
